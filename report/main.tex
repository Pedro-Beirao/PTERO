...
\include{body/chapter2} % Background
\include{body/chapter3} % Proposed Solution
\include{body/chapter4} % Implementation
\include{body/chapter5} % Validation
\include{body/chapter6} % Conclusion
