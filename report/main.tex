...
\title{IEC 61499 Compliant Remote Web-based IDE for Function Block Design}
\author{Pedro da Cunha Teixeira e Faro Beirão}

%% Uncomment next line for date of submission
\thesisdate{June 15, 2026}
...
\begin{Prolog}
  ...
  \lstlistoflistings
  \include{frontmatter/abbrevs}
\end{Prolog}

\StartBody

\include{body/chapter1} % Introduction
\include{body/chapter2} % Literature review
\include{body/chapter3} % State of the art
\include{body/chapter4} % Proposed Solution
\include{body/chapter5} % Prototype Development
\include{body/chapter6} % Results and analysis
